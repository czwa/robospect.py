...
print(D.y)
print(D.continuum)
RS.plot_spectrum(D, min=5800, max=5900, autoscale=False, output="/tmp/plotA.png")
print(RS)
...
RS.plot_spectrum(SS(), min=4860, max=5000, autoscale=False, errors=True, output="/tmp/plotB.png")
SS.fit_detection()
for l in SS.L:
